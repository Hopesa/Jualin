...
?>
				...
				<div class="col-sm-9 padding-right">
					<div class="features_items"><!--features_items-->
						<h2 class="title text-center">Item Search: <?php echo $search; ?></h2>
						<?php
...
$kolom=3;
$sql= mysql_query("SELECT * FROM `barang` WHERE `nama_barang` LIKE '%$search%';");
$i=0;
...
$query=mysql_num_rows(mysql_query("select * from barang WHERE `nama_barang` LIKE '%$search%';"));
